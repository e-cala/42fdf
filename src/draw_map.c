...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/26 09:22:40 by ecabanas          #+#    #+#             */
/*   Updated: 2023/06/26 09:36:23 by ecabanas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_map(t_meta *meta)
{
	...
	ft_reduce_z(meta->map.total_size,
		copy_points, meta->map.divisor);
	rotation_x(meta->map.total_size,
		copy_points, copy_points, meta->map.ang[X]);
	rotation_y(meta->map.total_size,
		copy_points, copy_points, meta->map.ang[Y]);
	rotation_z(meta->map.total_size,
		copy_points, copy_points, meta->map.ang[Z]);
	...
	mlx_put_image_to_window(meta->vars.mlx,
		meta->vars.win, meta->data.img, 0, 0);
}
